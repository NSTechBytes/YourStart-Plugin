...
namespace YourStart
{
    internal class Measure
    {
        ...
        $"Shortcut_BackGround_{i2}", $"Shortcut_Icon_{i2}", $"Shortcut_String_{i2}"
            ...
            api.Log(API.LogType.Debug, $"YourStart.dll: bgAction1={bgAction1}, bgAction2={bgAction2}");
            ...
            if (string.IsNullOrWhiteSpace(bgAction1) || string.IsNullOrWhiteSpace(bgAction2) ||
                string.IsNullOrWhiteSpace(icon1) || string.IsNullOrWhiteSpace(icon2) ||
                string.IsNullOrWhiteSpace(text1) || string.IsNullOrWhiteSpace(text2))
            {
                api.Log(API.LogType.Error, "YourStart.dll: One or more required values are invalid or empty.");
                return;
            }
            ...
            api.Execute($"[!SetOption Shortcut_BackGround_{i1} LeftMouseDownAction \"\"{bgAction2}\"\"]");
            api.Execute($"[!SetOption Shortcut_BackGround_{i2} LeftMouseDownAction \"\"{bgAction1}\"\"]");
